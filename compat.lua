...
love.graphics.getModes = function()
    return love.window.getFullscreenModes()
end

-- 4. Fix setBackgroundColor
local oldSetBackgroundColor = love.graphics.setBackgroundColor
love.graphics.setBackgroundColor = function(r, g, b, a)
    if type(r) == "table" then
        oldSetBackgroundColor(r[1] / 255, r[2] / 255, r[3] / 255, (r[4] or 255) / 255)
    else
        oldSetBackgroundColor(r / 255, g / 255, b / 255, (a or 255) / 255)
    end
end

-- 5. Key constant translation map
local keyMap = {
    kpenter = "return",
    escape = "escape",
